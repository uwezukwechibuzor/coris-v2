        ...
        <FlexColumn>
          ...
          <Card className={darkMode ? "dark-mode w-100" : "w-100"}>
            <FlexBetween>
              ...
              <strong>
                {getStakingParams?.params?.unbonding_time
                  ? periodsInDays(getStakingParams?.params.unbonding_time)
                  : null}
              </strong>
            </FlexBetween>
            <FlexBetween>
              ...
              <strong>
                {getStakingParams?.params?.max_validators
                  ? getStakingParams?.params.max_validators
                  : null}
              </strong>
            </FlexBetween>
            <FlexBetween>
              ...
              <strong>
                {getStakingParams?.params?.max_entries
                  ? getStakingParams.params.max_entries
                  : null}
              </strong>
            </FlexBetween>
            <FlexBetween>
              ...
              <strong>
                {getStakingParams?.params?.historical_entries
                  ? getStakingParams.params.historical_entries
                  : null}
              </strong>
            </FlexBetween>
