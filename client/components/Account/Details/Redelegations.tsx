              ...
              currentredelegations?.map((data) => (
                <tbody>
                  <tr className="striped">
                    ...
                    <td>
                      <Link
                        href="/[chain_id]/validator[address]"
                        as={`/${props?.chain_id}/validators/${data.redelegation.validator_src_address}`}
                      >
                        <a>
                          {data.redelegation
                            ? formatHash(
                    ...
                    <td>
                      <Link
                        href="/[chain_id]/validator[address]"
                        as={`/${props?.chain_id}/validators/${data.redelegation.validator_dst_address}`}
                      >
                        <a>
                          {data.redelegation
                            ? formatHash(
