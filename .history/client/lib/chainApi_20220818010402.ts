...
export const chainApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getChainAccountReledelgations: builder.query<any, any>({
      query: (delegator_address) => `${chainURL.cosmosChainREST}/cosmos/staking/v1beta1/delegators/${delegator_addre}/redelegations`,
      providesTags:  ['AccountDelegations'],
    }),
  }),
});
