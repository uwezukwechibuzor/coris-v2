...
export const chainValidatorReDelegationsEndpoint = (validator_addr) => `${chainURL.cosmosChainREST}/cosmos/staking/v1beta1/delegators/${validator_addr}/redelegations?pagination.limit=600`