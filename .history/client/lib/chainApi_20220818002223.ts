...
export const chainApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getChainDelegatorReward: builder.query<any, any>({
      query: (address) => `${chainURL.cosmosChainREST}/cosmos/distribution/v1beta1/delegators/${delegator_address}/rewards`,
      providesTags:  ['AccountBalance'],
    }),
  }),
});
