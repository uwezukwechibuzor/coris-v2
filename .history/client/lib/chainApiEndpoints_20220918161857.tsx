...
export const delegationRewardsEndpoint = (delegator_address) =>  `${chainURL.cosmosChainREST}/cosmos/distribution/v1beta1/delegators/${delegator_address}/rewards`;
...
export const accountUnDelegationsEndpoint = () => `${chainURL.cosmosChainREST}/cosmos/staking/v1beta1/delegators/${delegator_address}/unbonding_delegations`