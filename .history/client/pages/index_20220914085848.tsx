...
import { allChainValidatorsEndpoint, chainActiveValidatorsEndpoint, communityPoolEndpoint, inflationEndpoint } from "../lib/chainApiEndpoints";
...
function Home (props) {
 ...
 useEffect(() => {
  ...
  const allValidators = props.chainAllValidators
...
export async function getServerSideProps({  res }) {
     ...
     //get Pool
     const getPool =  await fetch(`https:${allChainValidatorsEndpoint}`)
