...
import { chainValidatorDelegationsEndpoint, chainValidatorsDetailsEndpoint, chainValidatorsSlashingSigningInfosDetailsEndpoint, chainValidatorUnDelegationsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ query, res }) {
 ...
 const getChainValidatorUnDelegations = await fetch(`https:${chainValidatorUnDelegationsEndpoint(query.address)}`);
  ...
  const getChainValidatorReDelegations = await fetch(`https:${chainValidatorUnDelegationsEndpoint(query.address)}`);
  const chainValidatorUnDelegations = await getChainValidatorUnDelegations.json();
