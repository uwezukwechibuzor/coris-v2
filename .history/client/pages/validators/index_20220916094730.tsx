...
export async function getServerSideProps(res, req) {
  ...
  const getAllChainValidators = await fetch(`https:${allChainValidatorsEndpoint}`) : null
  const chainAllValidators = isServerReq(req) ?  await getAllChainValidators.json();
