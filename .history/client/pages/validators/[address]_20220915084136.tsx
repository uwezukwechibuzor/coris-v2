...
function ValidatorsDetails(props) {
    ...
    const poolData =props?.chainValidatorReDelegation; 
    const  chainValidatorReDelegation = props?.chainValidatorReDelegation !== undefined? props?.chainValidatorReDelegation : null
  ...
  const data = {
    ...
    chainValidatorReDelegation:  chainValidatorReDelegation,
    poolData
  }
...
var chainValidatorReDelegation = []
chainValidatorDelegations?.delegation_responses?.map(async (delegator) => {
  ...
  const chainValidatorReDelegations = await getChainValidatorReDelegations.json();
    chainValidatorReDelegations.redelegation_responses.map(redelegation => {
      chainValidatorReDelegation.push(redelegation)
    })
})
