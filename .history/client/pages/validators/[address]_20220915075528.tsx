...
import { chainValidatorDelegationsEndpoint, chainValidatorsDetailsEndpoint, chainValidatorsSlashingSigningInfosDetailsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ query, res }) {
 ...
 const getChainValidatorUnDelegations = await fetch(`https:${chainValidatorDelegationsEndpoint(query.address)}`);
   const chainValidatorDelegations = await getChainValidatorDelegations.json();
