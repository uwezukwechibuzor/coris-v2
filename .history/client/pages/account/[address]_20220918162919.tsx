...
import { accountBalanceEndpoint, accountDelegationRewardsEndpoint, accountDelegationsEndpoint, authAccountEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ res, req }) {
    ...
    try {
     ...
     //get delegations
     const  accountDelegations  = isServerReq(req) ? await fetch(`https:${accountDelegationsEndpoint}`) : null
     const accountDelegatorRewards = await  accountDelegations.json()
