...
import { useGetChainAccountBalanceQuery, useGetChainAuthAccountAddressQuery, useGetChainDelegatorRewardsQuery } from '../../lib/chainApi';
...
function AccountDetails(props) {
   ...
   const delegationRewards = getDelegatorRewards.isLoading === false? getDelegatorRewards.data 
