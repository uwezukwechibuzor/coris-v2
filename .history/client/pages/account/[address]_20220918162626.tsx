...
import { accountBalanceEndpoint, accountDelegationRewardsEndpoint, authAccountEndpoint, delegationRewardsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ res, req }) {
    ...
    try {
     ...
     const getDelegatorRewards  = isServerReq(req) ? await fetch(`https:${accountDelegationRewardsEndpoint}`) : null
     const delegatorRewards = await getDelegatorRewards.json()
