...
import { accountBalanceEndpoint, authAccountEndpoint, delegationRewardsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ res, req }) {
    ...
    try {
     ...
     const getDelegatorRewards  = isServerReq(req) ? await fetch(`https:${delegationRewardsEndpoint}`) : null
     const getDelegatorRewards = await getDelegatorRewards.json()
