...
export async function getServerSideProps({ res, req }) {
    ...
    try {
     ...
     const  getAccountUnbondingDelegations  = isServerReq(req) ? await fetch(`https:${accountReDelegationsEndpoint}`) : null
     const  accountRedelegations = await  getAccountRedelegations.json()
