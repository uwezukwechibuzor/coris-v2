...
import { accountBalanceEndpoint, accountDelegationRewardsEndpoint, accountDelegationsEndpoint, accountReDelegationsEndpoint, authAccountEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ res, req }) {
    ...
    try {
     ...
     //get Redelegations
     const  getAccountReledelegations  = isServerReq(req) ? await fetch(`https:${accountReDelegationsEndpoint}`) : null
     const  getAccountReledelegations = await  getAccountReledelegations.json()
