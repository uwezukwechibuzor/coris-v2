...
import { distributionParamsEndpoint, govParamsEndpoint, mintingParamsEndpoint, slashingParamsEndpoint, stakingParamsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ res, req }) {
    ...
    //get chain node info
    const  getChainNodeInfo  =  isServerReq(req) ? await fetch(`https:${distributionParamsEndpoint}`) : null
