...
import { govParamsEndpoint, mintingParamsEndpoint, slashingParamsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ res, req }) {
    ...
    const getGovStakingParams =  isServerReq(req) ? await fetch(`https:${slashingParamsEndpoint}`) : null
