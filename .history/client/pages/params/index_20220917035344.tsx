...
function Params(props) {
   ...
   const paramsData = {
    ...
    govSlashingParams = props?.govSlashingParams;
    govStakingParams = props?.govStakingParams;
    govDistributionParams = props?.govDistributionParams;
    chainNodeInfo = props?.chainNodeInfo
   }
    return (
     <>
      <ParamsContent />
