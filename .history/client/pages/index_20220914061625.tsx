...
import { communityPoolEndpoint, inflationEndpoint } from "../lib/chainApiEndpoints";

function Home ({inflationData, commuintyPoolData}) {
 ...
 useEffect(() => {
  ...
  const communityPool = getCommunityPool.isLoading == false? formatNumbers(getCommunityPool?.data?.pool[0]?.amount) 
