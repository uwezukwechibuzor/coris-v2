...
import { proposalDetailsEndpoint, proposalVotingOptionsEndpoint } from '../../lib/chainApiEndpoints';
...
export async function getServerSideProps({ query, res, req }) {
    ...
    try {
     ...
     const getProposalDeposits =  isServerReq(req) ?  await fetch(`https:${proposalVotingOptionsEndpoint(query.id)}`) : null
     const proposalVotingOptions = await getProposalDeposits.json();
