                            ...
                            {txDetails?.txDetails?.tx_response?.tx?.body?.messages.map(message =>
                                <Accordion defaultActiveKey="0" >
                                    <Accordion.Item eventKey="0" className="accordion-item" style={{ background: darkMode ? '#19172d' : '#fff' }}>
                                        <Accordion.Header className="accordion-header" style={{ background: darkMode ? '#19172d' : '#fff' }}>
                                            <div>
                                                <h4 className="font-xl text-dark" style={{ background: darkMode ? '#19172d' : '#fff' }} >Type: <strong>{abbrMessage(message)}</strong></h4>
                                            </div>
                                        </Accordion.Header>
