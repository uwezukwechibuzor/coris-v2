            ...
            </Flex>
            {
                isFormattedView ? (
                    <Formatted className={darkMode ? 'dark-mode' : ''}>
                        ...
                        <Container className="my-3" style={{ background: darkMode ? 'red' : '#3a428a' }}>
                            {txDetails?.txDetails?.tx_response?.tx?.body?.messages.map(message =>
                                <Accordion defaultActiveKey="0" style={{ background: darkMode ? 'red' : '#3a428a' }} >
                                 
                                        <Accordion.Header className="accordion-header" style={{ background: darkMode ? 'red' : '#3a428a' }} >
                                            <div style={{ background: darkMode ? 'red' : '#3a428a' }}>
                                                <h4 className="font-xl text-dark" style={{ background: darkMode ? 'red' : '#3a428a' }}>Type: <strong style={{ background: darkMode ? 'red' : '#3a428a' }}>{abbrMessage(message)}</strong></h4>
                                            </div>
                                        </Accordion.Header>
