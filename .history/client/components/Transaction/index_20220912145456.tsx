                    ...
                    <Formatted className={darkMode ? 'dark-mode' : ''}>
                        ...
                        <Container className="my-3" >
                            {txDetails?.txDetails?.tx_response?.tx?.body?.messages.map(message =>
                                <Accordion defaultActiveKey="0" className={darkMode ? 'dark-mode' : ''}>
                                    <Accordion.Item eventKey="0" className="accordion-item" style={{ background: darkMode ? '#fff' : '#3a428a' }}>
                                        <Accordion.Header className="accordion-header" style={{ background: darkMode ? '#fff' : '#3a428a' }}>
                                            <div>
