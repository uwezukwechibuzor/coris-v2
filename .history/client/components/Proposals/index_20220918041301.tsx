        ...
        <GridItem className={darkMode ? 'dark-mode' : ''}>
         ...
         <table>
          ...
          <Flex>
            ...
            <ProgressBar striped variant="info" now={proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.abstain): 0} key={4} label={proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.abstain).toFixed(2) + '%': 0} />
          </ProgressBar>
            </div>
            <div className="ml-3">
              <b>Most voted on</b>
