          ...
          <Grid>
            ...
            <div className="ml-3">
              ...
              <FlexMiddle>
                ...
                <div>
                  <span>{tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.yes) ? 'first' : tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.no) ? 'second' : tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.no_with_veto) ? 'third' : 'fourth'}</span> 
