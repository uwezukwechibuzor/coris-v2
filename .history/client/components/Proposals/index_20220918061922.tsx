         ...
         <table>
          ...
          <Grid>
            ...
            <div className="ml-3">
              <b>Most voted on</b>
              <FlexMiddle>
                <Box style={{marginRight: '5px'}} className={tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.yes) ? 'first' : tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.yes) ? 'second' : tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.yes) ? 'third' : '' } />
                <div>
                  <span>No </span> 
