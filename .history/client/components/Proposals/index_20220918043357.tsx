         ...
         <table>
          ...
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.abstain).toFixed(2) + '%': 0} ({proposal?.final_tally_result?.abstain ? proposal.final_tally_result.abstain?) : 0} {COIN})</div>
            </Container>
          </Grid>
            </div>
            <div className="ml-3">
