        ...
        <Container style={{ marginTop: "20px" }}>
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.abstain).toFixed(2) + '%': 0} ({proposal?.proposal?.final_tally_result?.abstain ? proposal?.proposal.final_tally_result.abstain.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0} {COIN})</div>
            </Container>
          </Grid>
        </Container>
      </Box>
