    ...
    <div className={darkMode ? 'dark-mode' : ''}>
        ...
        <Container style={{ marginTop: "20px" }}>
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.no_with_veto).toFixed(2) + '%': 0} ({proposal?.proposal?.final_tally_result?.no_with_veto ? proposal?.proposal.final_tally_result.no_with_veto.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0} {COIN})</div>
            </Container>
            <Container>
              <Flex>
      ...
      <Box className={darkMode ? 'dark-mode' : ''} style={{ marginTop: "20px", padding: "20px" }}>
        ...
        <FlexBetween>
          ...
          <Container><strong>{proposal?.proposal.total_deposit ? proposal.proposal.total_deposit[0].amount/DENOM : null} {COIN}</strong></Container>
        </FlexBetween>
        <FlexBetween>
