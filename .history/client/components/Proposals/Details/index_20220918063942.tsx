        ...
        <Container style={{ marginTop: "20px" }}>
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.no).toFixed(2) + '%' : 0} ({proposal?.proposal?.final_tally_result?.no ? (proposal?.proposal.final_tally_result.no/DE) : 0} {COIN})</div>
            </Container>
            <Container>
              <Flex>
