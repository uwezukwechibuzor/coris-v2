        ...
        <Container style={{ marginTop: "20px" }}>
          <Grid>
            <Container>
              ...
              <div>{proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.yes).toFixed(2) + '%' : 0} ({proposal?.proposal?.final_tally_result?.yes ? proposal?.proposal.final_tally_result.yes) : 0}  {COIN})</div>
            </Container>
            <Container>
              <Flex>
