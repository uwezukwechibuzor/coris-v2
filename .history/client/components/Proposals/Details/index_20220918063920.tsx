        ...
        <Container style={{ marginTop: "20px" }}>
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.no).toFixed(2) + '%' : 0} ({proposal?.proposal?.final_tally_result?.no ? proposal?.proposal.final_tally_result.no.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0} {})</div>
            </Container>
            <Container>
              <Flex>
