      ...
      <Box className={darkMode ? 'dark-mode' : ''}>
        ...
        <Container>
          ...
          <ProgressBar style={{ height: "30px" }}>
            ...
            <ProgressBar striped style={{background}} now={proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.abstain): 0} key={4} label={proposal?.proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.abstain).toFixed(2) + '%': 0} />
          </ProgressBar>
        </Container>
