    ...
    <div className={darkMode ? 'dark-mode' : ''}>
      ...
      <Box className={darkMode ? 'dark-mode' : ''}>
        ...
        <Container>
          ...
          <Flex style={{ marginTop: '10px' }}>
            <span>{total}</span>
            <Container style={{ marginLeft: '40px' }}><strong>{finalTallyResultSum? finalTallyResultSum : ''} {proposal?.proposal?.total_deposit ? proposal?.proposal?.total_deposit[0].denom/DENOM : ''}</strong></Container>
          </Flex>
