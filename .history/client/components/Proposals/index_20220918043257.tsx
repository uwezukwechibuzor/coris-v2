         ...
         <table>
          ...
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.no_with_veto).toFixed(2) + '%': 0} ({proposal?.final_tally_result?.no_with_veto ? proposal.final_tally_result.no_with_veto : 0} {COIN})</div>
            </Container>
            <Container>
              <Flex>
