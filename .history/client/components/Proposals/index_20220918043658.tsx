        ...
        <GridItem className={darkMode ? 'dark-mode' : ''}>
         ...
         <table>
          ...
          <Flex>
            ...
            <ProgressBar striped variant="" now={proposal? tallyPercentage(proposal?.final_tally_result?.abstain): 0} key={4} label={proposal? tallyPercentage(proposal?.final_tally_result?.abstain).toFixed(2) + '%': 0} />
          </ProgressBar>
          <Grid>
            <Container>
              <Flex>
