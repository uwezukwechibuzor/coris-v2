         ...
         <table>
          ...
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.abstain).toFixed(2) + '%': 0} ({proposal?.final_tally_result?.abstain ? proposal.final_tally_result.abstain.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0} {proposal?.proposal.total_deposit ? proposal?.proposal.total_deposit[0].denom : ''})</div>
            </Container>
          </Grid>
            </div>
            <div className="ml-3">
