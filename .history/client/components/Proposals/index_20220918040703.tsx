...
function ProposalsContent(props) {
  ...
  getFirstFourActiveProposals.map(proposal => {
    finalTallyResultSum = Number(proposal?.final_tally_result?.yes) + Number(proposal?.final_tally_result?.no) + Number(proposal?.proposal?.final_tally_result?.no_with_veto) + Number(proposal?.proposal?.final_tally_result?.abstain)
