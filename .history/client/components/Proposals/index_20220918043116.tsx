         ...
         <table>
          ...
          <Grid>
            ...
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.no).toFixed(2) + '%' : 0} ({proposal?.final_tally_result?.no ? proposal.final_tally_result.no.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0} {COIN})</div>
            </Container>
            <Container>
              <Flex>
