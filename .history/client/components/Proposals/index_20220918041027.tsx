        ...
        <GridItem className={darkMode ? 'dark-mode' : ''}>
         ...
         <table>
          ...
          <Flex>
            ...
            <ProgressBar striped variant="success" now={proposal? tallyPercentage(proposal?.final_tally_result?.yes) : 0} key={1} label={proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.yes).toFixed(2) + '%' : 0} />
