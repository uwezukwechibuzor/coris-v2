         ...
         <table>
          ...
          <Grid>
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.yes).toFixed(2) + '%' : 0} ({proposal?.final_tally_result?.yes ? proposal.final_tally_result.yes.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0}  {proposal?.total_deposit/De ? proposal.total_deposit[0].denom : ''})</div>
            </Container>
            <Container>
              <Flex>
