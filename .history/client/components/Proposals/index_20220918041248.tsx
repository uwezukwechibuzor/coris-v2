        ...
        <GridItem className={darkMode ? 'dark-mode' : ''}>
         ...
         <table>
          ...
          <Flex>
            ...
            <ProgressBar striped variant="warning" now={proposal? tallyPercentage(proposal?.final_tally_result?.no_with_veto): 0} key={3} label={proposal? tallyPercentage(proposal?.proposal?.final_tally_result?.no_with_veto).toFixed(2) + '%': 0} />
