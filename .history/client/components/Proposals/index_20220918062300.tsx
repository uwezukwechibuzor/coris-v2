          ...
          <Grid>
            ...
            <div className="ml-3">
              ...
              <FlexMiddle>
                ...
                <div>
                  <span>{tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.yes) ? 'Yes' : tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.no) ? 'No' : tallyPercentage(max) === tallyPercentage(proposal?.final_tally_result?.no_with_veto) ? 'No With Veto' : 'fourth'}</span> 
