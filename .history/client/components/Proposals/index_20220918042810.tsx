         ...
         <table>
          ...
          <Grid>
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.yes).toFixed(2) + '%' : 0} ({proposal?.final_tally_result?.yes ? proposal.final_tally_result.yes.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0}  {})</div>
            </Container>
            <Container>
              <Flex>
