         ...
         <table>
          ...
          <Grid>
            <Container>
              ...
              <div>{proposal? tallyPercentage(proposal?.final_tally_result?.yes).toFixed(2) + '%' : 0} ({proposal?.final_tally_result?.yes ? proposal.final_tally_result.yes/DENOM : 0}  {COIN})</div>
            </Container>
            <Container>
              <Flex>
