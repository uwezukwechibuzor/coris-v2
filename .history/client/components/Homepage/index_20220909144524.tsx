      ...
      <Grid>
        <GridItem className={darkMode ? 'dark-mode first-item chart' : 'first-item chart'}>
          <Icon>
            {
              darkMode ? (
                <><img className="asset-6-2" src="" height="30" /><img className="asset-7-2" src="" height="20" /></>
              ) : (
                <><img className="asset-6-2" src="/img/asset-6-2@2x.png" height="30" /><img className="asset-7-2" src={coinData.symbol} height="20" /></>
              )
            }
          </Icon>
          <Stat>
            ...
            <Flex>
              ...
              <p style={{marginTop: '-12px'}}>5.67% (24h)</p>
            </Flex>
          </Stat>
          <br />
