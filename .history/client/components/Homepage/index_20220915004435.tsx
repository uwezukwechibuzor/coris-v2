...
function HomePageContent(props) {
  ...
  const totalValidators = props?.validators !== undefined ?  props?.validators?.length : null
  ...
  props?.validators? !== undefined ? allValidators?.validators.map(validatorsDetails => {
