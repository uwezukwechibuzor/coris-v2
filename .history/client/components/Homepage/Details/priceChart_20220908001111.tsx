...
const [priceChartXValuesFunction, setpriceChartXValuesFunction] = useState([])
const [ priceChartYValuesFunction, setpriceChartYValuesFunction] = useState([])
         ...
         .then(
           function (data) {
            for (var item in data.prices) {
                setpriceChartXValuesFunction(data.prices[item][0])
                setpriceChartYValuesFunction(data.prices[item][1])
             //console.log(data.prices[item][1])
              // getTotalIndex = item
      ...
      //console.log(priceChartXValuesFunction)
      console.log(priceChartYValuesFunction)
