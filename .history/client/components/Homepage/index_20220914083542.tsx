...
function HomePageContent(props) {
  ...
  const percentageOfVotingPower = getAllValidators.isLoading == false && getAllActiveVa.isLoading == false ? Math.round(Number(totalActiveVotingPower / totalVotingPower) * 100) : null
