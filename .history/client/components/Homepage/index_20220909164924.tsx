        ...
        <GridItem1 className={darkMode ? 'dark-mode second-item' : 'second-item'}>
          <FlexCenter className="h-100">
            <OverlapGroup13>
              ...
              <Address className={darkMode ? 'dark-mode' : ''}>{coinData?.market_data?.total_supply !== null? formatN(coinData?.market_data?.total_supply) +' '+ coinData?.symbol?.toUpperCase() : 'Null'} </Address>
            </OverlapGroup13>
          </FlexCenter>
        </GridItem1>
