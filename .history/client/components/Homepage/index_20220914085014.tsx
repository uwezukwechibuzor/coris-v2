...
function HomePageContent(props) {
  ...
  const totalValidators = allValidators !== undefined ? allValidators?.validators?.length : null
  ...
  allValidators !== undefined ? allValidators.validators.map(validatorsDetails => {
