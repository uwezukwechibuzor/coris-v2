...
function HomePageContent(props) {
  ...
  console.log(coinData?.market_data?.price_change_percentage_24h    )
        ...
        <GridItem className={darkMode ? 'dark-mode first-item chart' : 'first-item chart'}>
          ...
          <Stat>
            ...
            <Flex>
              ...
              <p style={{marginTop: '-12px'}}>{coinData?.market_data?.price_change_percentage_24h? coinData?.market_data?.price_change_percentage_24h.toFixed(2): nu}% (24h)</p>
            </Flex>
          </Stat>
          <br />
