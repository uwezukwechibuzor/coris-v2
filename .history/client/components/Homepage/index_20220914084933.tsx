...
function HomePageContent(props) {
  ...
  const totalValidators = allValidators !== undefined ? allValidators?.data?.validators?.length : null
  ...
  allValidators.isLoading == false ? getAllValidators?.data?.validators.map(validatorsDetails => {
  ...
  activeValidators == false ? activeValidators?.validators.map(validatorsDetails => {
  ...
  const percentageOfVotingPower = (totalActiveVotingPower / totalVotingPower) * 100
