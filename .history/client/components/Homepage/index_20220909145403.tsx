      ...
      <Grid>
        <GridItem className={darkMode ? 'dark-mode first-item chart' : 'first-item chart'}>
          <Icon>
            {
              darkMode ? (
                <><img className="asset-6-2" src={coinData?.image?.large} height="40" /><img className="asset-7-2" src="" height="20" /></>
              ) : (
                <><img className="asset-6-2" src={coinData?.image?.large} height="40" />   {coinData?.symbol}</>
              )
            }
          </Icon>
          <Stat>
