  ...
  return (
    <Wrapper className={darkMode ? 'dark-mode' : ''}>
      ...
      <Container className={darkMode ? 'dark-mode w-100' : 'w-100'}>
        ...
        <Col className={darkMode ? 'w-100 mt-3 dark-mode' : 'w-100 mt-3'}>
          <Card className={darkMode ? 'w-100 mt-3 dark-mode' : 'w-100 mt-3'}>
            <Card.Body className={darkMode ? 'w-100 mt-3 dark-mode' : 'w-100 mt-3'}>
              <Card.Title className={darkMode ? 'w-100 mt-3 dark-mode' : 'w-100 mt-3'}>Latest Blocks</Card.Title>
              <Card.Text>
              <Responsive>
