          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{slashingParamsData?.data?.params?.slash_fraction_double_sign ? slashingParametersData.slashingParamsData.data.params.slash_fraction_double_sign * 100 + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
