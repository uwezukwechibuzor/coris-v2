          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{slashingParamsData?.data?.params?.slash_fraction_downtime ? slashingParametersData.slashingParamsData.data.params.slash_fraction_downtime * 100 + '%' : null}</strong>
              </FlexBetween>
            </Card>
          </FlexColumn>
        </GridItem>
