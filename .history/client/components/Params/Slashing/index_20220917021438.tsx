          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{slashingParamsData?.data?.params?.min_signed_per_window ? slashingParametersData.slashingParamsData.data.params.min_signed_per_window * 100 + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
