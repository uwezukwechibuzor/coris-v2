          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              <FlexBetween>
                ...
                <strong>{govDepositParamsData?.getGovDepositParams?.data?.deposit_params?.min_deposit ? govDepositParamsData?.getGovDepositParams?.data?.deposit_params?.min_deposit[0]?.amount + '' + getGovDepositParams?.data?.deposit_params?.min_deposit[0]?.denom : null}</strong>
              </FlexBetween>
              <FlexBetween>
