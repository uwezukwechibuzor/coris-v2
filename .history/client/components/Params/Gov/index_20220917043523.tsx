         ...
         <GridItem>
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                <span>Quorom</span>
                <strong>{govTallyingParams?.data?.tally_params?.quorum ?  govTallyingParams.data.tally_params.quorum * 100 + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
                <span>Threshold</span>
              ...
              <FlexBetween>
                ...
                <strong>{govVotingParams?.voting_params?.voting_period ? periodsInDays(govVotingParamsData?.voting_params.voting_period) : null}</strong>
              </FlexBetween>
            </Card>
          </FlexColumn>
        </GridItem>
