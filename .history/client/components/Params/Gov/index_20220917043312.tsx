          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              <FlexBetween>
                ...
                <strong>{govDepositParams?.deposit_params?.min_deposit ? govDepositParams?.deposit_params?.min_deposit[0]?.amount + '' + ?.deposit_params?.min_deposit[0]?.denom : null}</strong>
              </FlexBetween>
              <FlexBetween>
