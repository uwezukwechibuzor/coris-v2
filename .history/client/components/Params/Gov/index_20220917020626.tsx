          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{govDepositParamsData?.getGovDepositParams?.data?.deposit_params?.max_deposit_period ? periodsInDays(getGovDepositParams.data.deposit_params.max_deposit_period) : null}</strong>
              </FlexBetween>
              <FlexBetween>
                <span>Quorom</span>
