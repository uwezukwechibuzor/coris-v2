...
function GovParams(props) {
  ...
  const darkMode = useAppSelector(state => state.general.darkMode)
    ...
    const {
      ...
      : 
      {status: 'fulfilled', endpointName: 'getChainGovParams', requestId: 'lxm2LlIK5i4Q2n9KaiUz9', originalArgs: 'deposit', startedTimeStamp: 1663376026874, …}
      govTallyingParamsData
      : 
      {status: 'fulfilled', endpointName: 'getChainGovParams', requestId: 'jFGo7FtUetLWKBVUqSLS7', originalArgs: 'tallying', startedTimeStamp: 1663376026875, …}
      govVotingParamsData
      :
        } = props;
   console.log(props)
