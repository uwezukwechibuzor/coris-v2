          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{distributionParamsData?.data?.params?.bonus_proposer_reward ? distributionParamtersData.distributionParamsData.data.params.bonus_proposer_reward * 100 + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
