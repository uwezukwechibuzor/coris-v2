          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{mintingParamsData?.data?.params?.inflation_rate_change ? Math.round(minitingParamtersData.mintingParamsData.data.params.inflation_rate_change * 100) + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
