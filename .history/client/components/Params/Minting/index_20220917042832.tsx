          ...
          <FlexColumn>
            ...
            <Card className={darkMode ? 'dark-mode w-100' : 'w-100'}>
              ...
              <FlexBetween>
                ...
                <strong>{mintingParamsData?.params?.inflation_min ? Math.round(mintingParamsData.params.inflation_min * 100) + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
                <span>Goal Bonded</span>
                <strong>{mintingParamsData?.params?.goal_bonded ? Math.round(mintingParamsData.data.params.goal_bonded * 100) + '%' : null}</strong>
              </FlexBetween>
              <FlexBetween>
                <span>Blocks Per Year</span>
                <strong>{mintingParamsData?.params?.blocks_per_year ? mintingParamsData.data.params.blocks_per_year : null}</strong>
              </FlexBetween>
            </Card>
          </FlexColumn>
        </GridItem>
