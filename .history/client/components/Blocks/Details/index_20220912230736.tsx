...
function BlockHeightContent(props: any) {
  ...
  const currentValidatorSignatureData = validatorsSignaturesDetails?.slice(offset, offset + PER_PAGE) const currentValidatorSignatureData = validatorsSignaturesDetails?.slice(offset, offset + PER_PAGE)
