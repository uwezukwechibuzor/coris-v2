...
function AccountRedelegationsContent(props) {
  ...
  const currentredelegations = redelegations?.delegation_responses?.slice(offset, offset + PER_PAGE) 
  const pageCount = Math.ceil(redelegations?.delegation_responses?.length / PER_PAGE);
            ...
            <Redelegation>
                <Responsive>
                    <table className="w-100">
                        ...
                        {currentredelegations?.redelegation_responses?.map(data =>
                            <tbody>
