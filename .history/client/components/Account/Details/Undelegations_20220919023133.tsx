...
function AccountUndelegationsContent(props) {
  ...
  const currentunDelegations = unDelegations?.delegation_responses?.slice(offset, offset + PER_PAGE) 
  const pageCount = Math.ceil(unDelegations?.delegation_responses?.length / PER_PAGE);
            ...
            <Underdelegation>
                <Responsive>
                    <table className="w-100">
                        ...
                        {unDelegations?.unbonding_responses?.map(data =>
                            <tbody>
