...
function AccountContents(props) {
    ...
    const balance = Number(accountBalance?.balances[0]?.amount)/DENOM

    const balancee = accountBalance?.balances[0]?.amount
   console.log(balance)
    let totalRewards = 0
                            ...
                            <Flex className='pt-3 w-100' style={{ flexDirection: "column" }}>
                                <div className="px-3">
                                    <Flex style={{ alignItems: 'center', justifyContent: "space-between", flexWrap: 'wrap'}}>
                                        ...
                                        <Flex className="ml-3">
                                            <h5><strong>{balance !== NaN ? balance.toFixed(4) : 0} {COIN}</strong></h5>
                                        </Flex>
                                    </Flex>
                                    <Flex style={{ alignItems: 'center', justifyContent: "space-between", flexWrap: 'wrap' }}>
                                        <Flex>
