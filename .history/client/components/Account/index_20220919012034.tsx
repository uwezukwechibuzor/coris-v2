...
function AccountContents(props) {
 ...
 console.log(totalRewards, totalDelegationsAmount, totalReledegationsAmount, totalUnboundingDelegationsAmount)
                            ...
                            <Flex className='pt-3 w-100' style={{ flexDirection: "column" }}>
                                <div className="px-3">
                                    ...
                                    <Flex style={{ alignItems: 'center', justifyContent: "space-between", flexWrap: 'wrap' }}>
                                        ...
                                        <Flex>
                                            <h5><strong>{delegationRewards?.rewards !== NaN ? 0 : totalRewards.toFixed(2)} {COIN}</strong></h5>
                                        </Flex>
                                    </Flex>
                                    <Flex style={{ alignItems: 'center', justifyContent: "space-between", flexWrap: 'wrap' }}>
                                        <Flex>
                                        ...
                                        <Flex>
                                            <h5><strong>{accountDelegations?.delegation_responses ? (totalDelegationsAmount/DENOM) : 0} {COIN}</strong></h5>
                                        </Flex>
                                    </Flex>
                                    <Flex style={{ alignItems: 'center', justifyContent: "space-between", flexWrap: 'wrap' }}>
                                        <Flex>
                                        ...
                                        <Flex>
                                            <h5><strong>{accountReledelgations?.redelegation_responses ? (totalReledegationsAmount/DENOM) : 0} {COIN}</strong></h5>
                                        </Flex>
                                    </Flex>
                                    <Flex style={{ alignItems: 'center', justifyContent: "space-between", flexWrap: 'wrap' }}>
                                        <Flex>
                                        ...
                                        <Flex>
                                            <h5><strong>{accountUnboundingDelegations?.unbonding_responses ? (totalUnboundingDelegationsAmount/DENOM).toFixed(2) : null} {COIN}</strong></h5>
                                        </Flex>
                                    </Flex>
                                </div>
                            </Flex>
