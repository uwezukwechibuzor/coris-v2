                ...
                {consensus?.map((details, index) => {
                      ...
                      return (
                        <tr className="validator-item-row" onClick={() => router.push(`/validators/${data[index].operator_address}`)} >
                          ...
                          <td>
                            {data? roundValidatorsVotingPowerToWholeNumber(data[index]?.tokens): 0}
                          ...
                          <td>{data[1] !== 'nil-Vote'? <img src="https://img.icons8.com/color/20/000000/cancel--v1.png"/> : <img src="https://img.icons8.com/fluency/48/000000/ok.png"/> }</td>
                          <td>{data[2]}</td>
                        </tr>
                     )
                    }
