            ...
            <Responsive>
              <table className="w-100 mt-3 table table-responsive">
                ...
                {consensus?.map((details) => {
                        ...
                        if (data !== undefined) {
                         console.log(data[0]?.description?.moniker)
                      ...
                      return (
                        <tr className="validator-item-row" onClick={() => router.push(`/validators/${data[0].operator_address}`)} >
                          ...
                          <td>
                            <Flex>
                              <FlexMiddle>
                                <img className="img" src={getValidatorsLogoFromWebsites(data[0]?.description?.website)} alt="" />
                              </FlexMiddle>
                              <FlexMiddle>
                          ...
                          <td>
                            {roundValidatorsVotingPowerToWholeNumber(data[0]?.tokens)}
