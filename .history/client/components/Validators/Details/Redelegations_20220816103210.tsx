...
function RedelegationsContent(props) {
  ...
  redelegation.map(d => {
   //console.log(d.redelegation.validator_dst_address)
   //console.log(d.redelegation.validator_src_address)
  })
...
const validators = getAllValidators.isLoading === false? getAllValidators.data.validators : null
 validators?.filter((validator, index) => {
     redelegation.map(redelegation =>{
           console.log(redelegation.redelegation.validator_src_address)
        if (validator?.operator_address.includes(redelegation.redelegation.validator_src_address) && validator?.operator_address.includes(redelegation.redelegation.validator_dst_address) ){  
        }
