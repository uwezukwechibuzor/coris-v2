...
const getValidatorDetailsByAddress = (operatorAddress) => {
const getAllValidators = useGetChainValidatorsQuery()
console.log(getAllValidators)   
...
console.log(getValidatorDetailsByAddress('cosmosvaloper1sjllsnramtg3ewxqwwrwjxfgc4n4ef9u2lcnj0'))
