...
const validators = getAllValidators.isLoading === false? getAllValidators.data.validators : null
 validators?.map((validator, index) => {
    return redelegation.map(redelegation =>{
        if (validator?.operator_address === redelegation.redelegation.validator_src_address && validator?.operator_address === redelegation.redelegation.validator_dst_address) ){  
