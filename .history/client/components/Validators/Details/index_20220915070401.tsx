...
const missedBlocks = chainValidatorsSlashingInfo !== undefined? getValSigningInfo?.data?.val_signing_info?.missed_blocks_counter : null
console.log(chainValidatorsSlashingInfo)
