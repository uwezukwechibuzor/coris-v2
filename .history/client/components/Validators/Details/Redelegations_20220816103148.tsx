...
const validators = getAllValidators.isLoading === false? getAllValidators.data.validators : null
 validators?.filter((validator, index) => {
     redelegation.map(redelegation =>{
        ...
        if (validator?.operator_address.includes(redelegation.redelegation.validator_src_address) && validator?.operator_address.includes(redelegation.redelegation.validator_src_address) ){  
        }
