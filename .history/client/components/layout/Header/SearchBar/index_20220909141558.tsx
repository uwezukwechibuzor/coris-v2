...
console.log(searchedData)
    ...
    const optionList = [
      { value: searchedData, label: searchedData },
    ];
    ...
    <div className={`search-bar ${className || ""} ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="dropdown-container">
        <Select
          ...
          isSearchable={true}
          placeholder="Search by Block Height / Valoper"  className={darkMode ? "dark-mode" : " "} onChange={event => props.setQuery(event.target.value)}
        />
      </div>
    </div>
  );
