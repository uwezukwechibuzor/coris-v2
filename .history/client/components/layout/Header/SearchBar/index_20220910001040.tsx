              ...
              <ListGroup className="w-100">
                {
                  searchResult?.map((item) => (
                    <ListGroup.Item key={item?.id} className={darkMode ? "dark-mode text-white no-border text-white" : "no-border"}>{searchedData? searchedData : err}{searchedDataa}</ListGroup.Item>
                  ))
                }
              </ListGroup>
            </SearchResult>
