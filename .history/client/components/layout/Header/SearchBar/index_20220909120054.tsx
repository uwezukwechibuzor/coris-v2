...
console.log(searched)
  ...
  return (
    <SearchBar1 className={`search-bar ${className || ""} ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <Alert>
          ddddddddddlllllllllllllllllllllllllllllllllllllllllllllllllllllddddddddddlllllllllllllllllllllllllllllllllllllllllllllllllllllddddddddddlllllllllllllllllllllllllllllllllllllllllllllllllllll
        </Alert>
    </SearchBar1>
  );
}
