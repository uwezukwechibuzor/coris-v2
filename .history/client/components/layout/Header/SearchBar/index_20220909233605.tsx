...
export function SearchBar(props) {
  ...
  searchingValidators?.filter(data => {
    ...
    } else if (query !== data.operator_address || query !== searchingValidators?.description?.moniker) {
      err = 'No Data Found';
    ...
    }else if(searchingValidators?.description?.moniker)
  })
  console.log(searchingValidators?.description?.moniker)
