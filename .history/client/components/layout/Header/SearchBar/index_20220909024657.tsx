...
export function SearchBar(props) {
 ...
 const searchingValidators = getAllChainValidators.isLoading === false? getAllChainValidators.data.validators.map(data => data) : null
 console.log(searchingValidators)
  ...
  return (
    <SearchBar1 className={`search-bar ${className || ""} ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <TextInput placeholder="Search by Block Height / Valoper" type="text" className={darkMode ? "dark-mode" : " "} />
