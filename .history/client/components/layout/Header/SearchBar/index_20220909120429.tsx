...
console.log(searched)
  ...
  return (
    <SearchBar1 className={`search-bar ${className || ""} ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <Card>
      <Card.Body>This is some text within a card bodylllllllllllllllllllllllllllllllllllls is some text within a card bodyllllllllllllllllllllllllllllllllllllllllll.</Card.Body>
    </Card>
    </SearchBar1>
  );
}
