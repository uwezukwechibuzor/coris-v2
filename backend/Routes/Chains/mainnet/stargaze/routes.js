...
app.get("/stargaze/all_validators", async (req, res) => {
  try {
...
app.get("/stargaze/active_validators", async (req, res) => {
  try {
...
//get chain inflation
app.get("/stargaze/chain_inflation", async (req, res) => {
  try {
...
app.get("/stargaze/chain_community_pool", async (req, res) => {
  try {
...
//get chain pool
app.get("/stargaze/chain_pool", async (req, res) => {
  try {
...
app.get("/stargaze/block_height_details", async (req, res) => {
  try {
...
app.get("/stargaze/block_height_txs", async (req, res) => {
  try {
    const height = req.query.height;
    const response = await fetch(
...
app.get("/stargaze/chain_txs_hash", async (req, res) => {
  try {
...
app.get("/stargaze/chain_validator_details/:address", async (req, res) => {
  try {
...
app.get(
  "/stargaze/chain_validator_slashing_signing_info_details/:cons_adddress",
  async (req, res) => {
    try {
...
app.get(
  "/stargaze/chain_validator_delegations/:validator_adddress",
  async (req, res) => {
    try {
...
app.get(
  "/stargaze/chain_validator_undelegations/:validator_adddress",
  async (req, res) => {
    try {
      const validator_adddress = req.params.validator_adddress;
      const response = await fetch(
...
app.get(
  "/stargaze/chain_validator_undelegations/:delegator_adddress",
  async (req, res) => {
    try {
...
app.get("/stargaze/chain_consensus", async (req, res) => {
  try {
...
app.get("/stargaze/chain_minting_params", async (req, res) => {
  try {
...
app.get("/stargaze/chain_gov_params", async (req, res) => {
  try {
...
app.get("/stargaze/chain_slashing_params", async (req, res) => {
  try {
...
app.get("/stargaze/chain_staking_params", async (req, res) => {
  try {
...
app.get("/stargaze/chain_distribution_params", async (req, res) => {
  try {
...
//get chain node info
app.get("/stargaze/chain_node_info", async (req, res) => {
  try {
...
//get chain proposals
app.get("/stargaze/chain_proposals", async (req, res) => {
  try {
...
app.get("/stargaze/chain_proposal_details", async (req, res) => {
  try {
...
app.get("/stargaze/chain_proposal_voting_options", async (req, res) => {
  try {
...
app.get("/stargaze/chain_proposal_tally_options", async (req, res) => {
  try {
    const id = req.query.id;
...
app.get("/stargaze/chain_proposal_deposits", async (req, res) => {
  try {
    const id = req.query.id;
...
app.get("/stargaze/chain_auth_account", async (req, res) => {
  try {
...
app.get("/stargaze/chain_account_txs_by_events/:address", async (req, res) => {
  try {
...
app.get("/stargaze/chain_account_balance", async (req, res) => {
  try {
    const address = req.query.address;
...
app.get("/stargaze/chain_account_delegation_rewaards", async (req, res) => {
  try {
...
app.get("/stargaze/chain_account_delegations", async (req, res) => {
  try {
    const delegator_address = req.query.delegator_address;
    const response = await fetch(
...
app.get("/stargaze/chain_account_redelegations", async (req, res) => {
  try {
    const delegator_address = req.query.delegator_address;
    const response = await fetch(
...
app.get("/stargaze/chain_account_undelegations", async (req, res) => {
  try {
    const delegator_address = req.query.delegator_address;
    const response = await fetch(
